    ...
    <>
      <div className="about-page-wrapper">
        ...
        <div className="about-section-wrapper">
          ...
          <p>
            Loom is a platform that combines 300+ Local Brands, helping you
            explore new items, brands, and collections. Items on Loom are always
      ...
      <div className="about-page-wrapper">
        <div className="about-section-wrapper">
          ...
          <p>
            ...
            as a loom weaves threads into a single yarn, Loom seamlessly
        ...
        <div className="about-section-wrapper">
          ...
          <p>
            ...
            process, and Loom is your dedicated companion in this sartorial
            adventure.
          </p>
          <p>
        ...
        <div className="about-section-wrapper">
          ...
          <p>
            ...
            story-driven brands was unheard of at this scale before. Loom leans
