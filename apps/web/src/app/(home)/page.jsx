    ...
    <div className="gender-wrapper">
      ...
      <div className="genders">
        <Link href="/categories?gender=women,unisex" className="gender">
          <img
            src="https://res.cloudinary.com/dffgye7z3/image/upload/v1725840213/women_lpshuo.webp"
            alt="Men categories"
          />
        ...
        <Link href="/categories?gender=men,unisex" className="gender">
          <img
            src="https://res.cloudinary.com/dffgye7z3/image/upload/v1725840214/men_ysf6jd.webp"
            alt="Men categories"
          />
          <div className="button-container">
