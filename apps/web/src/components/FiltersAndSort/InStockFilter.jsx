...
export function InStockFilter() {
    ...
    function toggleInStock() {
        ...
        params.set('availability', currentAvailability === 'in-stock' ? 'all' : 'in-stock');
        params.set('page', 1);
    ...
    return <>
        <div className="in-stock-wrapper">
            <input className="filters-checkbox" type="checkbox" id="inStockCheckbox" checked={isChecked()} onChange={toggleInStock} />
